{
  ...
  base-files = {
    ...
    sha256 = "d8075d49b79ae1c3f6dfd2efd63d540b12388c4f9e139333ac3685f9fdcc2a8d";
  };
  block-mount = {
  ...
  kernel = {
    version = "6.12.74~9a5a5d1452df743bd923783d09f10e88-r1";
    filename = "kernel-6.12.74~9a5a5d1452df743bd923783d09f10e88-r1.apk";
    depends = [ "libc" ];
    provides = [ "kernel-any" ];
    sha256 = "654fa89084ddafb9eb5f4e975c6240a3f0b4286511d4a36f74574957f4708a04";
  };
  layerscape-ppfe = {
  ...
  uboot-envtools = {
    ...
    sha256 = "d269760a01628f65b99f849a7cc27748da985a8d0e830ee4817adbcc2c665f67";
  };
  umbim = {
