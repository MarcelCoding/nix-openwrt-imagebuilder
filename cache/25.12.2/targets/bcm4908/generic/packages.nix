{
  ...
  base-files = {
    ...
    sha256 = "3545a1ef093796e58ed9d36663ac8217cf2d969e3ae0ac0b67c4032a5b5dd21a";
  };
  bcm4908img = {
    version = "3";
  ...
  kernel = {
    version = "6.12.74~979d0774cde439adfa7583dbecfa6499-r1";
    filename = "kernel-6.12.74~979d0774cde439adfa7583dbecfa6499-r1.apk";
    depends = [ "libc" ];
    provides = [ "kernel-any" ];
    sha256 = "97cda9630d59ba509f35890dae1b751942c94a5143c9e821a6721c5abd8b709c";
  };
  libatomic1 = {
    version = "14.3.0-r5";
